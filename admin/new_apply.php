...
$import = "UPDATE new_apply1 set post_uscore ='0',average_score='0',adminstatus = '1',course_choice = '".$los."',afac = '".safee($condb,$adfac)."' ,adept='".safee($condb,$addept)."' where stud_id ='".$id[$i]."' ";
